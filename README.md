...
注：纯文本浏览器推荐在Linux环境下使用w3c，同时我推荐使用Linux访问这些站点;
    用Linux访问中文站点时我建议使用GBK或GB10380编码格式;
```
...
<hteml>
    <table>
        ...
        <tr>
            <td>3</td>
            <td>每日一句</td>
            <td>v1.hitoko.cn/?encode=text</td>
            <td>✅</td>
            <td>模拟终端</td>
        </tr>
        <tr>
            <td>4</td>
            <td>wttr 天气</td>
            <td>v2.wttr.in/CITY_NAME</td>
            <td>✅</td>
            <td>天气网站 CITY_NAME为城市全称的英文名</td>
        </tr>
        <tr>
            <td>5</td>
            <td>词典</td>
            <td>dict.org/d:WORD</td>
            <td>✅</td>
            <td>WORD是要查的词语</td>
        </tr>
    </table>
